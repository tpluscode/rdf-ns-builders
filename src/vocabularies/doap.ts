...
const builder = namespace("http://usefulinc.com/ns/doap#") as any;
export const strict = builder as NamespaceBuilder<keyof Doap> & Doap;
export const loose = builder as NamespaceBuilder & Doap;
