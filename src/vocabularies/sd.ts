...
const builder = namespace("http://www.w3.org/ns/sparql-service-description#") as any;
export const strict = builder as NamespaceBuilder<keyof Sd> & Sd;
export const loose = builder as NamespaceBuilder & Sd;
