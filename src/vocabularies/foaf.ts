...
const builder = namespace("http://xmlns.com/foaf/0.1/") as any;
export const strict = builder as NamespaceBuilder<keyof Foaf> & Foaf;
export const loose = builder as NamespaceBuilder & Foaf;
