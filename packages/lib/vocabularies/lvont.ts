...
const builder = namespace("http://lexvo.org/ontology#") as any;
export const strict = builder as NamespaceBuilder<keyof Lvont> & Lvont;
export const loose = builder as NamespaceBuilder & Lvont;
